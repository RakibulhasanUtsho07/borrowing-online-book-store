...
const categories = [
  {
    ...
    category_name: "Story",
    categories: [
      { id: "bk-str-9x1", title: "Echoes of the Forgotten", author: "Elena Thorne", available_quantity: 12, image_url: "https://m.media-amazon.com/images/S/compressed.photo.goodreads.com/books/1691569088i/195972975.jpg" },
      { id: "bk-str-4v2", title: "Silicon Shadows", author: "Marcus Vane", available_quantity: 25, image_url: "https://m.media-amazon.com/images/I/711tsLK8oEL._UF1000,1000_QL80_.jpg" },
      { id: "bk-str-8m3", title: "Midnight in the Archive", author: "Julian Black", available_quantity: 10, image_url: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT6x2OQT59krvMllXs_2IP8-7KhqHofOyg4Vg&s" },
      { id: "bk-str-11k4", title: "Gardens of the Moon", author: "Steven Erikson", available_quantity: 18, image_url: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSWmxcBQt9T4rClMa5_XBESLmom6TU238Emow&s" },
      { id: "bk-str-14p5", title: "Under the Desert Stars", author: "Amira Al-Sayed", available_quantity: 9, image_url: "https://m.media-amazon.com/images/I/91qn841i-CL._UF1000,1000_QL80_.jpg" },
      { id: "bk-str-19z6", title: "The Martian Chronicles", author: "Ray Bradbury", available_quantity: 22, image_url: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTOsRm8KPteYAD7Ix90-xL4CDbLanEYAVwwww&s" }
    ]
  },
  {
    category_id: 2,
    category_name: "Tech",
    categories: [
      { id: "bk-tch-2a1", title: "Quantum Leap: Neural Networks", author: "Dr. Aris Thorne", available_quantity: 5, image_url: "https://media.springernature.com/w153/springer-static/cover/book/978-981-95-1683-4.jpg" },
      { id: "bk-tch-5b2", title: "Edge Computing 101", author: "Liam Chen", available_quantity: 15, image_url: "https://m.media-amazon.com/images/I/715w3Q4XcML.jpg" },
      { id: "bk-tch-7c3", title: "Full Stack Mastery", author: "Devin Rivers", available_quantity: 20, image_url: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTLal77tRssd2TT5tk3z65KYMkJjDnAFjfVXA&s" },
      { id: "bk-tch-10d4", title: "The Rust Revolution", author: "Clara Schmidt", available_quantity: 7, image_url: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSQiiaVLehM9vcLbcbRcdQwsqJyunfW84Fm-Q&s" },
      { id: "bk-tch-13e5", title: "The API Design Handbook", author: "Sanjay Gupta", available_quantity: 14, image_url: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQUuPcigUF6lk3hikZ4l_Z2r2UY7dap-MyW-Q&s" },
      { id: "bk-tch-16f6", title: "Cybersecurity Threats 2026", author: "Kevin Mitnick", available_quantity: 6, image_url: "https://m.media-amazon.com/images/I/61j11NnRJZL._UF1000,1000_QL80_.jpg" },
      { id: "bk-tch-18g7", title: "Mastering Go", author: "Mihalis Tsoukalos", available_quantity: 17, image_url: "https://m.media-amazon.com/images/I/714VDMA1+aL._AC_UF1000,1000_QL80_.jpg" }
    ]
  },
  {
    category_id: 3,
    ...
    categories: [
      { id: "bk-sci-3x1", title: "The Biological Blueprint", author: "Sarah Jenkins", available_quantity: 8, image_url: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQaV8zLJ75TGWpMO-Z99vckyEtncCaXn0OBuw&s" },
      { id: "bk-sci-6y2", title: "The Last Glacier", author: "Dr. Helena Wu", available_quantity: 3, image_url: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQyWt55DH6bBvPRfhj4Umer5bNm5mGtOEHrPA&s" },
      { id: "bk-sci-9z3", title: "Astrophysics of the Void", author: "Neil deGrasse Tyson", available_quantity: 30, image_url: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSYdnlHGXtTO-wV33PO0PPR3u8voLXOfepo_w&s" },
      { id: "bk-sci-12w4", title: "Neuroplasticity: Rewiring the Mind", author: "Dr. Andrew Huberman", available_quantity: 40, image_url: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRWue4Hk-G-012XrR32eODgbSY1yqoGJ6PFWw&s" },
      { id: "bk-sci-15q5", title: "Principles of Deep Learning", author: "Ian Goodfellow", available_quantity: 11, image_url: "https://m.media-amazon.com/images/I/511X0SSqYBL._AC_UF1000,1000_QL80_.jpg" },
      { id: "bk-sci-17r6", title: "The Song of the Forest", author: "Oliver Sacks", available_quantity: 13, image_url: "https://m.media-amazon.com/images/I/71cRaQuU66L._AC_UF1000,1000_QL80_.jpg" },
      { id: "bk-sci-20s7", title: "The Chemistry of Everything", author: "Dr. Peter Atkins", available_quantity: 35, image_url: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT3QzXSSJUuWzYP4NbWBonJH-4qxTQcEG-PbA&s" }
    ]
  }
];
 const singleCategory = categories.find(category=> category.category_id === Number(id))
 return singleCategory? singleCategory.categories :[]
}
    ...
    <div className='p-2 space-y-5'>
      {
        books.map((book, ind) =>
            <div key={ind} className='space-y-4'>
                ...
                <button className='btn bg-amber-500 px-4 text-white'>Read More</button>
